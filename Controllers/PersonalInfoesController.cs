...
namespace InsuranceAgency__.Controllers
{
    public class PersonalInfoesController : Controller
    {
        ...
        public PersonalInfoesController(InsuranceAgencyDataContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FIO,BirthDate,PassportNumber,PassportSeries,Region,City,Address,PhoneNumber")] PersonalInfo personalInfo)
        {
