...
namespace InsuranceAgency__.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(InsuranceAgencyDataContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ReceiptNumber,FIO,DatePayment")] Payment payment)
        {
            if (id != payment.Id)
            {
                return NotFound();
